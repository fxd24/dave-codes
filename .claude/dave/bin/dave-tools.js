...
const MODEL_PROFILES = {
  ...
  'dave-tdd-developer':       { quality: 'opus', balanced: 'sonnet', budget: 'sonnet' },
  'dave-code-reviewer':       { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  'dave-security-reviewer':   { quality: 'opus', balanced: 'sonnet', budget: 'haiku' },
  ...
  'dave-practical-verifier':  { quality: 'sonnet', balanced: 'sonnet', budget: 'haiku' },
};
...
function cmdResolveModel(cwd, agentType, raw) {
  ...
  if (config.models && config.models.profiles && config.models.profiles[profileName]) {
    ...
    const roleMap = {
      ...
      'architect': 'planner',
      'executor': 'executor',
      'dave-tdd-developer': 'executor',
      'researcher': 'executor',
      'dave-code-reviewer': 'verifier',
      'dave-security-reviewer': 'verifier',
      'review-aggregator': 'verifier',
      'verifier': 'verifier',
      'dave-practical-verifier': 'verifier',
      'reflect': 'executor',
